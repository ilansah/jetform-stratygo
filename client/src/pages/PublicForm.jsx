                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-2xl px-4">
                            ...
                            >
                                ...
                                <div className="relative z-10 flex flex-col items-center">
                                    <div className="w-40 h-40 bg-white rounded-full flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform duration-300 overflow-hidden">
                                        <img src={fibreIcon} alt="Fibre" className="w-full h-full object-contain p-2" />
                                    </div>
                            ...
                            >
                                ...
                                <div className="relative z-10 flex flex-col items-center">
                                    <div className="w-40 h-40 bg-white rounded-full flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform duration-300 overflow-hidden">
                                        <img src={energieIcon} alt="Energie" className="w-full h-full object-contain p-2" />
                                    </div>
